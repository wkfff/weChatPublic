...
<script>
	export default {
		...
		created: function() {
			let hotAPI = "newManageAction!eachJsonQueryPictureList.action?newManage.publishObject=1&type=4"
			let localAPI = "newManageAction!eachJsonQueryAllList.action?newManage.publishObject=1&newManage.newType=10&row=100"
