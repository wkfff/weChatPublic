		...
		<div class="g-warp">
			...
			<div class="g-tab">
				<ul class="nav nav-tabs" id="myTab" role="tablist">
					<li class="nav-item">
						<a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">政策法规</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" id="notice-tab" data-toggle="tab" href="#notice" role="tab" aria-controls="notice" aria-selected="false">行政审批</a>
					</li>
				</ul>
...
<script>
	export default {
		...
		created: function() {
			let hotAPI = "newManageAction!eachJsonQueryPictureList.action?newManage.publishObject=1&type=5"
			let localAPI = "newManageAction!eachJsonQueryAllList.action?newManage.publishObject=1&newManage.newType=0&row=100"
			let noticeAPI = "newManageAction!eachJsonQueryAllList.action?newManage.publishObject=1&newManage.newType=17&row=100"
